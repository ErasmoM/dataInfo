...
<body>
    <div class="containerCadastro" id="cadastro1">
        <form action="" method="post" id="formulario">
            ...
            <div class="input-group">
                <label for="">Email</label><br> <input type="email" class="form-control" name="email" id="email"
                    size="37"><br>
            </div>
            <div class="input-group">
                <label for="">Senha</label> <br> <input type="password" class="form-control" name="senha" id="senha"
                    size="37"><br>
            </div>
            <div class="input-group">
            ...
            <button type="submit" id="bt">Atualizars</button>
        </form>
    </div>
